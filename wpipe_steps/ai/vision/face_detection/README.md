...
Pre-built step for HFFaceDetectionStep functionality.
...
## ⚙️ Configuration
Namespace: `wpipe_steps.huggingface.vision.face_detection`

## 🚀 How to Use
```python
from wpipe_steps.huggingface.vision.face_detection import HFFaceDetectionStep
```
