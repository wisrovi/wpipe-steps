...
Pre-built step for HFImageStyleTransferStep functionality.
...
## ⚙️ Configuration
Namespace: `wpipe_steps.huggingface.vision.style_transfer`

## 🚀 How to Use
```python
from wpipe_steps.huggingface.vision.style_transfer import HFImageStyleTransferStep
```
