...
Pre-built step for HFFeatureExtractionStep functionality.
...
## ⚙️ Configuration
Namespace: `wpipe_steps.huggingface.text.feature_extraction`

## 🚀 How to Use
```python
from wpipe_steps.huggingface.text.feature_extraction import HFFeatureExtractionStep
```
