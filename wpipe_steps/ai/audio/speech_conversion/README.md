...
Pre-built step for HFSpeechToSpeechStep functionality.
...
## ⚙️ Configuration
Namespace: `wpipe_steps.huggingface.audio.speech_conversion`

## 🚀 How to Use
```python
from wpipe_steps.huggingface.audio.speech_conversion import HFSpeechToSpeechStep
```
