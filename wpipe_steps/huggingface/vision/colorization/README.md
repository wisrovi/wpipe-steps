...
Pre-built step for HFImageColorizationStep functionality.
...
## ⚙️ Configuration
Namespace: `wpipe_steps.huggingface.vision.colorization`

## 🚀 How to Use
```python
from wpipe_steps.huggingface.vision.colorization import HFImageColorizationStep
```
