...
Pre-built step for HFTableQuestionAnsweringStep functionality.
...
## ⚙️ Configuration
Namespace: `wpipe_steps.huggingface.text.table_qa`

## 🚀 How to Use
```python
from wpipe_steps.huggingface.text.table_qa import HFTableQuestionAnsweringStep
```
