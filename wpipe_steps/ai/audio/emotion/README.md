...
Pre-built step for HFAudioEmotionRecognitionStep functionality.
...
## ⚙️ Configuration
Namespace: `wpipe_steps.huggingface.audio.emotion`

## 🚀 How to Use
```python
from wpipe_steps.huggingface.audio.emotion import HFAudioEmotionRecognitionStep
```
