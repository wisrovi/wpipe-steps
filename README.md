...
| Step Name | Import | Type | Example | Description |
|-----------|--------|------|---------|-------------|
| `mongo_insert` | `from wpipe_steps.database import MongoInsertStep` | Sync | [example.py](examples/database/mongodb/example.py) | Insert documents into MongoDB |
...
| Step Name | Import | Type | Example | Description |
|-----------|--------|------|---------|-------------|
| `text_classification` | `from wpipe_steps.ai import HFTextClassificationStep` | Sync | [classification_example.py](examples/ai/text/classification_example.py) | Classify text into categories using local BERT models |
| `sentiment_analysis` | `from wpipe_steps.ai import HFSentimentAnalysisStep` | Sync | [sentiment_example.py](examples/ai/text/sentiment_example.py) | Analyze sentiment (positive/negative) using DistilBERT |
| `zero_shot_classification` | `from wpipe_steps.ai import HFZeroShotClassificationStep` | Sync | [zero_shot_example.py](examples/ai/text/zero_shot_example.py) | Classify text into custom categories without training |
| `ner` | `from wpipe_steps.ai import HFNerStep` | Sync | [ner_example.py](examples/ai/text/ner_example.py) | Extract named entities (PER, ORG, LOC) from text |
| `fill_mask` | `from wpipe_steps.ai import HFFillMaskStep` | Sync | [fill_mask_example.py](examples/ai/text/fill_mask_example.py) | Fill masked tokens in text using BERT |
| `question_answering` | `from wpipe_steps.ai import HFQuestionAnsweringStep` | Sync | [qa_example.py](examples/ai/text/qa_example.py) | Answer questions based on context using BERT |
| `summarization` | `from wpipe_steps.ai import HFSummarizationStep` | Sync | [summarization_example.py](examples/ai/text/summarization_example.py) | Summarize long text using BART/T5 |
| `translation` | `from wpipe_steps.ai import HFTranslationStep` | Sync | [translation_example.py](examples/ai/text/translation_example.py) | Translate text between languages using T5/Marian |
| `text_generation` | `from wpipe_steps.ai import HFTextGenerationStep` | Sync | [text_gen_example.py](examples/ai/text/text_gen_example.py) | Generate text using GPT-2 or similar models |
| `conversational` | `from wpipe_steps.ai import HFConversationalStep` | Sync | [conversation_example.py](examples/ai/text/conversation_example.py) | Chat conversation with memory using BlenderBot |
| `text2text` | `from wpipe_steps.ai import HFText2TextGenerationStep` | Sync | [text2text_example.py](examples/ai/text/text2text_example.py) | Text-to-text generation using T5 |
| `multiple_choice` | `from wpipe_steps.ai import HFMultipleChoiceStep` | Sync | [multiple_choice_example.py](examples/ai/text/multiple_choice_example.py) | Multiple choice QA using RoBERTa |
| `table_qa` | `from wpipe_steps.ai import HFTableQuestionAnsweringStep` | Sync | [table_qa_example.py](examples/ai/text/table_qa_example.py) | Answer questions on table data |
| `feature_extraction` | `from wpipe_steps.ai import HFFeatureExtractionStep` | Sync | [feature_extraction_example.py](examples/ai/text/feature_extraction_example.py) | Extract features/embeddings using BERT |
| `sentence_embeddings` | `from wpipe_steps.ai import HFSentenceEmbeddingsStep` | Sync | [sentence_embeddings_example.py](examples/ai/text/sentence_embeddings_example.py) | Generate sentence embeddings (sentence-transformers) |
| `sentence_similarity` | `from wpipe_steps.ai import HFSentenceSimilarityStep` | Sync | [sentence_similarity_example.py](examples/ai/text/sentence_similarity_example.py) | Calculate semantic similarity between sentences |
| `reranking` | `from wpipe_steps.ai import HFRerankingStep` | Sync | [reranking_example.py](examples/ai/text/reranking_example.py) | Rerank documents for RAG (cross-encoder) |
| `semantic_search` | `from wpipe_steps.ai import HFSemanticSearchStep` | Sync | [semantic_search_example.py](examples/ai/text/semantic_search_example.py) | Semantic search using sentence embeddings |
| `document_qa` | `from wpipe_steps.ai import HFDocumentQuestionAnsweringStep` | Sync | [document_qa_example.py](examples/ai/text/document_qa_example.py) | Answer questions on document images |
| `language_id` | `from wpipe_steps.ai import HFLanguageIdentificationStep` | Sync | [language_id_example.py](examples/ai/text/language_id_example.py) | Detect language of text |
| `automatic_speech_recognition` | `from wpipe_steps.ai import HFAutomaticSpeechRecognitionStep` | Sync | [asr_example.py](examples/ai/audio/asr_example.py) | Transcribe audio to text using Whisper |
| `audio_classification` | `from wpipe_steps.ai import HFAudioClassificationStep` | Sync | [audio_class_example.py](examples/ai/audio/audio_class_example.py) | Classify audio content |
| `text_to_speech` | `from wpipe_steps.ai import HFTextToSpeechStep` | Sync | [tts_example.py](examples/ai/audio/tts_example.py) | Convert text to speech |
| `voice_activity_detection` | `from wpipe_steps.ai import HFVoiceActivityDetectionStep` | Sync | [vad_example.py](examples/ai/audio/vad_example.py) | Detect voice activity in audio |
| `audio_to_audio` | `from wpipe_steps.ai import HFAudioToAudioStep` | Sync | [audio2audio_example.py](examples/ai/audio/audio2audio_example.py) | Process audio (denoising) |
| `audio_emotion_recognition` | `from wpipe_steps.ai import HFAudioEmotionRecognitionStep` | Sync | [emotion_example.py](examples/ai/audio/emotion_example.py) | Recognize emotion in speech |
| `speech_to_speech` | `from wpipe_steps.ai import HFSpeechToSpeechStep` | Sync | [speech_conv_example.py](examples/ai/audio/speech_conv_example.py) | Convert speech style |
| `speaker_diarization` | `from wpipe_steps.ai import HFSpeakerDiarizationStep` | Sync | [diarization_example.py](examples/ai/audio/diarization_example.py) | Identify who spoke when |
| `image_classification` | `from wpipe_steps.ai import HFImageClassificationStep` | Sync | [img_class_example.py](examples/ai/vision/img_class_example.py) | Classify images using ViT |
| `object_detection` | `from wpipe_steps.ai import HFObjectDetectionStep` | Sync | [obj_det_example.py](examples/ai/vision/obj_det_example.py) | Detect objects in images |
| `image_segmentation` | `from wpipe_steps.ai import HFImageSegmentationStep` | Sync | [segmentation_example.py](examples/ai/vision/segmentation_example.py) | Segment images semantically |
| `image_to_text` | `from wpipe_steps.ai import HFImageToTextStep` | Sync | [caption_example.py](examples/ai/vision/caption_example.py) | Generate text description of images |
| `visual_qa` | `from wpipe_steps.ai import HFVisualQuestionAnsweringStep` | Sync | [vqa_example.py](examples/ai/vision/vqa_example.py) | Answer questions on images |
| `zero_shot_img` | `from wpipe_steps.ai import HFZeroShotImageClassificationStep` | Sync | [zero_shot_img_example.py](examples/ai/vision/zero_shot_img_example.py) | Classify images without training |
| `depth_estimation` | `from wpipe_steps.ai import HFDepthEstimationStep` | Sync | [depth_example.py](examples/ai/vision/depth_example.py) | Estimate depth of images |
| `image_to_image` | `from wpipe_steps.ai import HFImageToImageStep` | Sync | [img2img_example.py](examples/ai/vision/img2img_example.py) | Transform images (style, super-res) |
| `inpaining` | `from wpipe_steps.ai import HFInpaintingStep` | Sync | [inpaint_example.py](examples/ai/vision/inpaint_example.py) | Fill missing areas in images |
| `colorization` | `from wpipe_steps.ai import HFImageColorizationStep` | Sync | [colorize_example.py](examples/ai/vision/colorize_example.py) | Colorize black & white images |
| `super_resolution` | `from wpipe_steps.ai import HFImageSuperResolutionStep` | Sync | [superres_example.py](examples/ai/vision/superres_example.py) | Upscale images |
| `style_transfer` | `from wpipe_steps.ai import HFImageStyleTransferStep` | Sync | [style_example.py](examples/ai/vision/style_example.py) | Artistic style transfer |
| `ocr` | `from wpipe_steps.ai import HFOcrStep` | Sync | [ocr_example.py](examples/ai/vision/ocr_example.py) | Extract text from images |
| `face_detection` | `from wpipe_steps.ai import HFFaceDetectionStep` | Sync | [face_example.py](examples/ai/vision/face_example.py) | Detect faces in images |
| `background_removal` | `from wpipe_steps.ai import HFImageBackgroundRemovalStep` | Sync | [nobg_example.py](examples/ai/vision/nobg_example.py) | Remove backgrounds from images |
| `video_classification` | `from wpipe_steps.ai import HFVideoClassificationStep` | Sync | [vid_class_example.py](examples/ai/video/vid_class_example.py) | Classify video content |
| `video_interpolation` | `from wpipe_steps.ai import HFVideoFrameInterpolationStep` | Sync | [vid_interp_example.py](examples/ai/video/vid_interp_example.py) | Interpolate video frames |
| `doc_visual_qa` | `from wpipe_steps.ai import HFDocumentVisualQuestionAnsweringStep` | Sync | [doc_vqa_example.py](examples/ai/multimodal/doc_vqa_example.py) | QA on document images |
| `image_text_to_text` | `from wpipe_steps.ai import HFImageTextToTextStep` | Sync | [img_text_example.py](examples/ai/multimodal/img_text_example.py) | Multimodal image+text to text |
| `any_to_any` | `from wpipe_steps.ai import HFAnyToAnyStep` | Sync | [any2any_example.py](examples/ai/multimodal/any2any_example.py) | Any-to-any multimodal models |
| `table_detection` | `from wpipe_steps.ai import HFTableDetectionStep` | Sync | [table_det_example.py](examples/ai/multimodal/table_det_example.py) | Detect tables in documents |
