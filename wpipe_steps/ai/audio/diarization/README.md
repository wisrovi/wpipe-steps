...
Pre-built step for HFSpeakerDiarizationStep functionality.
...
## ⚙️ Configuration
Namespace: `wpipe_steps.huggingface.audio.diarization`

## 🚀 How to Use
```python
from wpipe_steps.huggingface.audio.diarization import HFSpeakerDiarizationStep
```
