...
Pre-built step for HFVoiceActivityDetectionStep functionality.
...
## ⚙️ Configuration
Namespace: `wpipe_steps.huggingface.audio.voice_activity`

## 🚀 How to Use
```python
from wpipe_steps.huggingface.audio.voice_activity import HFVoiceActivityDetectionStep
```
