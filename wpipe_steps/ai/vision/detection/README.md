...
Pre-built step for HFObjectDetectionStep functionality.
...
## ⚙️ Configuration
Namespace: `wpipe_steps.huggingface.vision.detection`

## 🚀 How to Use
```python
from wpipe_steps.huggingface.vision.detection import HFObjectDetectionStep
```
