...
Pre-built step for HFInpaintingStep functionality.
...
## ⚙️ Configuration
Namespace: `wpipe_steps.ai.vision.inpainting`

## 🚀 How to Use
```python
from wpipe_steps.ai.vision.inpainting import HFInpaintingStep
```
